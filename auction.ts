...
resolver: IABIFuncCall<{node: bytes32},{address: address}>;
owner: IABIFuncCall<{node: bytes32},{owner: address}>;
setSubnodeOwner: IABIFuncSend<{node: bytes32, label: bytes32, owner: address}>;
setTTL: IABIFuncSend<{node: bytes32, ttl: uint64}>;
ttl: IABIFuncCall<{node: bytes32},{timeToLive: uint64}>;
...
resolver: ABIFuncCallConnected<{node: bytes32},{address: address}>;
owner: ABIFuncCallConnected<{node: bytes32},{owner: address}>;
...
ttl: ABIFuncCallConnected<{node: bytes32},{timeToLive: uint64}>;
